 ...
 * you've made (per one page of orders) on AMAZON.CA . To use the script,
...
newarr = pricearr.filter(function(value){ if (!value.innerHTML) {return false} else {return value.innerHTML.includes("CDN$")}});
